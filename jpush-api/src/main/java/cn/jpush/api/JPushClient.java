...
//	public static final String REGISTRATION_ID = "0900e8d85ef";  
    ...
    private ScheduleResult createPeriodicalSchedule(String name, String start, String end, String time,
	 ...
	 public static PushPayload buildPushObject_all_messageWithExtras(String content) {  
	        return PushPayload.newBuilder()  
	                .setPlatform(Platform.all())  
	                .setAudience(Audience.all()) 
	                .setMessage(Message.newBuilder()  
	 ...
	 public static PushPayload buildPushObject_allAlias_audienceMore_messageWithExtras(String toalias,String title,String content) {  
	        return PushPayload.newBuilder()  
	                .setPlatform(Platform.all())  
	                .setAudience(Audience.newBuilder()  
	 ...
	 public static PushPayload buildPushObject_allTag_audienceMore_messageWithExtras(String totag,String title,String content) {  
	        return PushPayload.newBuilder()  
	                .setPlatform(Platform.all())  
	                .setAudience(Audience.newBuilder()  
	 ...
	 public static PushPayload buildPushObject_allAlias_audienceMore_alertWithExtras(String toalias,String title,String content) {  
	        return PushPayload.newBuilder()  
	                .setPlatform(Platform.all())  
	                .setAudience(Audience.newBuilder()  
	                        .addAudienceTarget(AudienceTarget.alias(toalias))  
...
//	                .setNotification(Notification.android(content, title, null))  
                   ...
                   .addPlatformNotification(IosNotification.newBuilder()  
                           .incrBadge(1)  
                            .addExtra("ftitle", title)  //soundin-进电子围栏；soundout出电子围栏;soundcharge-充值;soundbattery-电量
	                        .addExtra("ftype", 1).build()) 
                   .build())  	                        
	                .build();  
	 } 
	    
	 public static PushPayload buildPushObject_allTag_audienceMore_alertWithExtras(String totag,String title,String content) {  
	        return PushPayload.newBuilder()  
	                .setPlatform(Platform.all())  
	                .setAudience(Audience.newBuilder()  
	                        .addAudienceTarget(AudienceTarget.tag(totag))  
